...
int hcns[] = {	2, 4, 6, 12, 24, 36, 48, 60, 120, 180,
				 240, 360, 720, 840, 1260, 1680, 2520, 
...
int main()
{
	int x;
	int index;
	std::vector<int> hcnv(hcns, hcns + sizeof(hcns)/sizeof(int));
	cin >> x;
	for (unsigned int i = 0; i < hcnv.size(); i++)
	{
		if (hcns[i] > x)
			break;
		index = i;
