...
void solve() {
    cin >> n;
    vector<vector<int>> ans1(7);
    ans1[1] = {1}; 
    ans1[2] = {1, 2};
    ans1[3] = vector<int>({1,2,2});
    ans1[4] = vector<int>({1, 2, 2, 3});
    ans1[5] = vector<int>({1,2,2,3,3});
    ans1[6] = vector<int>({1,2,2,3,3,4});
    vector<int> aux1 = {0, 1,2,2,3,3,4};
