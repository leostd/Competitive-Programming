...
void solve() {
    ...
    if (n%2) {
        ...
        i++; // empezamos a asignar pares desde el 2do espacio en blanco de izq a der
             //
    ...
    for1(i, 2*n+1) if (ans[i] == 0) ans[i] = 1;
    for1(i, 2*n+1) cout << ans[i] << " ";
    cout << endl;
}
