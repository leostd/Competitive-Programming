// time-limit: 2000
// problem-url: https://codeforces.com/contest/2130/problem/D
...
class FenwickTree {
  // BE AWARE OF THE SIZE OF THE TREE WHEN INSTATIATED.
  // Think about cleaning one instance vs. create a new one
